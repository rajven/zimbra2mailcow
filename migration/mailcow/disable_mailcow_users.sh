...
# ============================================================
# DISABLE MAILCOW USERS
# ============================================================
# Usage: ./disable_mailcow_users.sh mailcow_full_20260909.csv
# ============================================================
...
LOG_FILE="/root/mailcow/disable_users_$(date +%Y%m%d_%H%M%S).log"
...
tail -n +2 "${CSV_FILE}" | while IFS='|' read -r email password displayName aliases quota active attributes; do
    ...
    JSON_TMPL='"attr":{"active":"0","sogo_access":"0"},"items":["%EMAIL%"]'
